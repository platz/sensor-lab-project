...
# This class implements a Python interface to the 'SensingLight'
# message type.
#
...
class SensingLight(tinyos.message.Message.Message):
    # Create a new SensingLight of size 6.
